...
from . import views
from django.conf.urls.static import static # to serve media files in development mode
from django.conf import settings # to serve media files in development mode
